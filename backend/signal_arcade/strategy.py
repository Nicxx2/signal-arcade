...
INTEGRITY_POLICY_VERSION = "integrity-gates-v2"
...
LEARNABLE_BASELINE_VERSIONS = frozenset(
    {PREVIOUS_BASELINE_VERSION, RECENT_BASELINE_VERSION, BASELINE_VERSION}
)
...
def integrity_policy_for_baseline(baseline_version: str) -> str:
    ...
    if baseline_version in {RECENT_BASELINE_VERSION, BASELINE_VERSION}:
